...
namespace ECommerceAPI.Persistence.Services
{
    public class BasketService : IBasketService
    {
        ...
        public BasketService(IHttpContextAccessor httpContextAccessor, IOrderReadRepository orderReadRepository, UserManager<AppUser> userManager, IBasketWriteRepository basketWriteRepository, IBasketReadRepository basketReadRepository, IBasketItemWriteRepository basketItemWriteRepository, IBasketItemReadRepository basketItemReadRepository)
        {
